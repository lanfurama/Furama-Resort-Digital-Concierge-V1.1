        ...
        <>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                >
                    ...
                    <button
                        onClick={onCancel}
                        className="absolute top-4 right-4 p-1.5 rounded-full text-gray-400 hover:text-gray-600 hover:bg-gray-100 touch-manipulation"
                        aria-label={t('cancel')}
                    >
                        <X className="w-5 h-5" />
                    </button>
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-medium shadow-md hover:shadow-lg active:scale-[0.98] touch-manipulation"
                    >
                    ...
                    <button
                        onClick={onCancel}
                        className="w-full mt-3 text-sm text-gray-500 hover:text-gray-700 py-2 touch-manipulation"
                    >
                        {t('cancel')}
                    </button>
                </div>
