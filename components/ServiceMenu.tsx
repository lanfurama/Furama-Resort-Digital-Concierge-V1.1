        ...
        <div className="p-4 grid grid-cols-2 gap-3">
            {services.map((s) => (
                <button 
                    ...
                    className={`relative flex flex-col items-center justify-center p-5 bg-gradient-to-br ${s.lightBg} backdrop-blur-sm rounded-3xl border-2 ${s.borderColor} transition-all duration-300 active:scale-95 overflow-hidden`}
                    style={{
                ...
                >
                    ...
                    {/* Service Name */}
                    <span className={`relative z-10 font-bold text-gray-800 text-center text-sm`}>
                        {s.name}
                    </span>
                </button>
            ))}
