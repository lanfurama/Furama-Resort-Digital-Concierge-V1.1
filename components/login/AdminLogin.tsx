...
export const AdminLogin: React.FC<AdminLoginProps> = ({ onLoginSuccess, setLanguage }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-5 relative bg-gray-50">
      {/* Back Button */}
      <button
      ...
      <div className="w-full max-w-md bg-white rounded-lg shadow border border-gray-200 p-5 sm:p-6 z-10 relative">
        ...
        <div className="flex items-center justify-center gap-2 mb-5">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">Furama Resort & Villas Danang</p>
          </div>
        </div>
