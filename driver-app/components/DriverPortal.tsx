    ...
    return (
        <div className="min-h-screen bg-white text-gray-900 flex flex-col relative">
            ...
            <header className="bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700 text-white shadow-lg p-4 flex items-center justify-between z-50">
                <div className="flex items-center gap-4 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1.5">
                            <MapPin size={13} className={`flex-shrink-0 ${gpsPermissionStatus === 'granted'
                                ? 'text-white/80'
                                : 'text-yellow-300'
                                }`} />
                ...
                {/* Right Icons - Enhanced with Mobile Touch Targets */}
                <div className="flex items-center gap-1 sm:gap-1.5 flex-shrink-0 ml-2">
                    <button
                        onClick={() => setShowProfileModal(true)}
                        className="touch-btn p-2.5 sm:p-2 rounded-xl hover:bg-white/10 transition-all text-white/80 active:scale-95"
                        title="Edit Profile"
                    >
                    ...
                    <button
                        ...
                        className={`touch-btn p-2.5 sm:p-2 rounded-xl hover:bg-white/10 transition-all active:scale-95 ${soundEnabled ? 'text-white' : 'text-white/60'
                            }`}
                        title={soundEnabled ? 'Sound On - Click to mute' : 'Sound Off - Click to unmute'}
                    >
                        {soundEnabled ? <Volume2 size={20} className="sm:w-[18px] sm:h-[18px]" /> : <VolumeX size={20} className="sm:w-[18px] sm:h-[18px]" />}
                    </button>
                    <button
                        onClick={async () => {
            ...
            <div className="bg-white border-b border-gray-200 shadow-sm px-2 sm:px-4">
                <div className="flex">
                    <button
                        onClick={() => setViewMode('REQUESTS')}
                        className={`flex-1 py-4 sm:py-3.5 px-3 sm:px-5 font-bold text-sm transition-all duration-300 border-b-2 relative active:bg-gray-50 ${viewMode === 'REQUESTS'
                            ? 'text-emerald-600 border-emerald-600'
                            : 'text-gray-500 border-transparent hover:text-gray-700'
                            }`}
                    >
                        <span className="flex items-center justify-center gap-2">
                            <Car size={18} className="sm:w-4 sm:h-4" />
                            <span className="hidden xs:inline">REQUESTS</span>
                            <span className="xs:hidden">JOBS</span>
                            <span className={`text-xs px-2 py-0.5 rounded-full ${viewMode === 'REQUESTS'
                    ...
                    <button
                        ...
                        className={`flex-1 py-4 sm:py-3.5 px-3 sm:px-5 font-bold text-sm transition-all duration-300 border-b-2 relative active:bg-gray-50 ${viewMode === 'HISTORY'
                            ? 'text-emerald-600 border-emerald-600'
                            : 'text-gray-500 border-transparent hover:text-gray-700'
                            }`}
                    >
                        <span className="flex items-center justify-center gap-2">
                            ...
                            HISTORY
                            <span className={`text-xs px-2 py-0.5 rounded-full ${viewMode === 'HISTORY'
                                ? 'bg-emerald-100 text-emerald-700'
                                : 'bg-gray-100 text-gray-600'
                                }`}>
                                {historyRides.length}
                    ...
                    <>
                        ...
                        {myCurrentRide ? (
                            <div className="m-4 bg-white rounded-2xl shadow-xl border-2 border-emerald-200 overflow-hidden">
                                {/* Status Header */}
                                <div className={`bg-gradient-to-r ${myCurrentRide.status === BuggyStatus.ON_TRIP
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-2 mb-3">
                                                ...
                                                <button
                                                    ...
                                                    className={`relative flex items-center gap-2 px-3 py-2 rounded-lg transition-all ${hasUnreadChat
                                            ...
                                            >
                                                        ...
                                                        {rideType.labels.length > 0 && (
                                                            <div className="flex items-center gap-1 ml-2">
                                                                {rideType.labels.map((label, idx) => (
                                                                    <span
                                                                        key={idx}
                                                                        className={`text-[10px] font-bold px-1.5 py-0.5 rounded ${label === 'AC'
                                                ...
                                                <div className="p-3">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        {/* Accept Button - Mobile Optimized */}
                                                        <div className="flex flex-col justify-center flex-shrink-0 w-full sm:w-auto mt-2 sm:mt-0">
                                                            <button
                                                                onClick={() => acceptRide(ride.id)}
                                                                disabled={loadingAction === ride.id || loadingAction !== null}
                                                                className="mobile-full-btn bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-6 py-4 sm:py-3 rounded-xl font-bold text-base sm:text-sm hover:shadow-lg hover:shadow-emerald-500/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed sm:min-w-[110px] flex items-center justify-center gap-2 active:scale-[0.98]"
                                                            >
            ...
            {/* Create Manual Ride Button - Mobile FAB */}
            {!myCurrentRide && viewMode === 'REQUESTS' && (
                <button
                    onClick={() => setShowCreateModal(true)}
                    className="touch-btn-xl fixed right-4 w-16 h-16 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl shadow-2xl flex items-center justify-center text-white z-40 border-2 border-emerald-400/30 hover:shadow-emerald-500/50 transition-all active:scale-95"
                    style={{
                    ...
                    >
                        <div className="flex justify-between items-center p-5 border-b-2 border-gray-200/60 sticky top-0 bg-white/95 backdrop-blur-sm z-10">
                            ...
                            <button
                                ...
                                className="touch-btn p-2.5 hover:bg-gray-100 rounded-xl transition-colors active:scale-95"
                            >
